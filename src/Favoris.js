...
export default function Favoris({ show, favorite}){
  const [addFav, setAddFav]=useState(favorite);
    ...
    function onButtonClick(){
      ...
      <div onClick={onButtonClick} className={classNames({ 'no-fav': ! addFav, 'fav': addFav })}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="35"  height="35" fill="currentColor" class="bi-star-fill" viewBox="0 0 16 16">
